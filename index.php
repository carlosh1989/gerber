<?php
    ...
    */
    function responsive_images($atts){
        ...
        $uri_parameters_extra_small = "f_auto,q_".$compresion.",w_544";  #Portrait phones (<544px)
        $uri_parameters_small       = "f_auto,q_".$compresion.",w_768";  #Landscape phones (≥544px - <768px)
        $uri_parameters_medium      = "f_auto,q_".$compresion.",w_992";  #Tablets (≥768px - <992px)
        $uri_parameters_large       = "f_auto,q_".$compresion.",w_1200"; #Desktops (≥992px - <1200px)
        $uri_parameters_extra_large = "f_auto,q_".$compresion.",w_1900"; #Desktops (≥1200px)
